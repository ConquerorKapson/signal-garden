  ...
  return (
    <main className="relative flex flex-col items-center justify-center min-h-screen bg-[var(--bg)] px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute -top-[20%] -left-[20%] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[var(--sky)]/5 to-transparent blur-3xl" />
        <div className="absolute bottom-[5%] -right-[15%] w-[400px] h-[400px] rounded-full bg-gradient-to-tl from-[var(--sage)]/6 to-transparent blur-3xl" />
      </div>
